...
def updatebrand(id):
    ...
    update: Brand = Brand.query.get_or_404(id)
    ...
    brand = update.name
    return render_template('products/addbrand.html', title='Udate brand', brands='brands', updatebrand=update)

@app.route('/deletebrand/<int:id>', methods=['GET', 'POST'])
def deletebrand(id):
    brand: Brand = Brand.query.get_or_404(id)
    if request.method == "POST":
